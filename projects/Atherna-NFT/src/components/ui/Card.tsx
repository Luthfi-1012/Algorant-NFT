  ...
  ({ className, hover = true, children, ...props }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(
          'rounded-xl border border-slate-700 bg-slate-800/50 p-6 shadow-lg backdrop-blur-sm',
          hover && 'transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl hover:shadow-purple-500/20',
          className
        )}
        {...props}
      >
